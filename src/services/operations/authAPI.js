...
export function signUp(
    ...
    return async (dispatch) => {
        ...
        try {
            ...
            console.log("SIGNUP API RESPONSE............", response)   //yhn tk to vhl gya
...
export function getPasswordResetToken(email, setEmailSent){
    ...
    return async(dispatch) => {
        ...
        try{
            ...
            console.log("RESET PASSWORD TOLEN ERROR",error);
...
export function resetPassword(password, confirmPassword, token, navigate){
    return async(dispatch) => {
        ...
        try{
            ...
            console.log("Reset paswrod response", response);
            ...
            console.log("REset password mme error");
